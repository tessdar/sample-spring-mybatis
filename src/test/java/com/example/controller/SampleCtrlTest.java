...
public class SampleCtrlTest {
	...
	public void givenDepartmentIdWhenGetEmpList() throws Exception {
		...
		given(messageReturn.getRestRespList(empLists))
				.willReturn(new ResponseEntity<List<EmpListVo>>(empLists, HttpStatus.OK));
	...
	public void givenEmployeeDataWhenPostEmpSave() throws Exception {
		...
		mockMvc.perform(post("/api/emp/save").content(element)
	...
	public void givenNoneWhenGetDepList() throws Exception {
		...
		given(messageReturn.getRestRespList(depLists))
				.willReturn(new ResponseEntity<List<DepListVo>>(depLists, HttpStatus.OK));
	...
	public void givenNoneWhenGetJobList() throws Exception {
		...
		given(messageReturn.getRestRespList(jobLists))
				.willReturn(new ResponseEntity<List<JobListVo>>(jobLists, HttpStatus.OK));
	...
	public void givenNoneWhenGetDepChart() throws Exception {
		...
		given(messageReturn.getRestRespList(depCharts))
				.willReturn(new ResponseEntity<List<DepChartVo>>(depCharts, HttpStatus.OK));
	...
	public void givenNoneWhenGetJoChart() throws Exception {
		...
		given(messageReturn.getRestRespList(jobCharts))
				.willReturn(new ResponseEntity<List<JobChartVo>>(jobCharts, HttpStatus.OK));
